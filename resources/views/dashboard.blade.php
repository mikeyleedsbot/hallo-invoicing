    ...
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="relative overflow-hidden bg-white rounded-xl shadow-sm border border-gray-100 dark:bg-gray-800 dark:border-gray-700 p-6">
                ...
                <div>
                    ...
                    <p class="mt-2 flex items-center text-sm text-gray-600 dark:text-gray-400">
                        <span class="font-medium">0 facturen</span>
            ...
            <div class="relative overflow-hidden bg-white rounded-xl shadow-sm border border-gray-100 dark:bg-gray-800 dark:border-gray-700 p-6">
                ...
                <div>
                    ...
                    <p class="mt-2 text-3xl font-bold text-gray-900 dark:text-white">0</p>
                    <p class="mt-2 flex items-center text-sm text-gray-600 dark:text-gray-400">
                        <span>Wachtend op goedkeuring</span>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 dark:bg-gray-800 dark:border-gray-700 p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <button class="group relative flex items-center gap-4 px-6 py-5 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white rounded-xl transition-all shadow-sm hover:shadow-md">
                    ...
                    <div class="text-left flex-1">
                        <span class="block font-semibold">Nieuwe Factuur</span>
                ...
                <button class="group relative flex items-center gap-4 px-6 py-5 bg-white hover:bg-gray-50 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-900 dark:text-white border border-gray-200 dark:border-gray-600 rounded-xl transition-all shadow-sm hover:shadow-md">
                    ...
                    <div class="text-left flex-1">
                        <span class="block font-semibold">Nieuwe Offerte</span>
                ...
                <button class="group relative flex items-center gap-4 px-6 py-5 bg-white hover:bg-gray-50 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-900 dark:text-white border border-gray-200 dark:border-gray-600 rounded-xl transition-all shadow-sm hover:shadow-md">
                    ...
                    <div class="text-left flex-1">
                        <span class="block font-semibold">Nieuwe Klant</span>
                        <span class="text-xs text-gray-500 dark:text-gray-400">Voeg klant toe</span>
                    </div>
                    <svg class="w-5 h-5 text-gray-400 transform group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                    </svg>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 dark:bg-gray-800 dark:border-gray-700">
            <div class="px-6 py-5 border-b border-gray-200 dark:border-gray-700">
                <div class="flex items-center justify-between">
                    ...
                    <a href="#" class="text-sm font-medium text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 flex items-center gap-1">
                        Bekijk alle
