<x-app-layout>
    <div class="space-y-6">
            ...
            <form action="{{ route('quotes.store') }}" method="POST" x-data="invoiceForm()" @submit.prevent="submitForm">
                @csrf
                    ...
                    <div class="lg:col-span-2 space-y-6">
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                {{-- Invoice Number --}}
                                <div>
                                    <label for="quote_number" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                        Offertenummer <span class="text-red-500">*</span>
                                    </label>
                                    <input type="text" name="quote_number" id="quote_number" value="{{ $quoteNumber }}"
                                ...
                                {{-- Invoice Date --}}
                                <div>
                                    <label for="quote_date" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                        Offertedatum <span class="text-red-500">*</span>
                                    </label>
                                    <input type="date" name="quote_date" id="quote_date" value="{{ now()->format('Y-m-d') }}"
                                ...
                                {{-- Due Date --}}
                                <div>
                                    <label for="valid_until" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                        Geldig tot <span class="text-red-500">*</span>
                                    </label>
                                    <input type="date" name="valid_until" id="valid_until" value="{{ now()->addDays(14)->format('Y-m-d') }}"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                                        required>
                                    @error('valid_until')
                                        <p class="mt-1 text-sm text-red-600 dark:text-red-500">{{ $message }}</p>
                                ...
                                <div class="md:col-span-2">
                                    <label for="valid_days" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                        Geldigheid (dagen)
                                    </label>
